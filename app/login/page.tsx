...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Prototype only — no real authentication happens.
                    ...
                    <form className="mt-6 space-y-4" onSubmit={handleSubmit} noValidate>
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full rounded-xl border bg-white/70 px-3.5 py-2.5 text-sm outline-none transition-colors placeholder:text-muted-foreground/60 focus:border-accent focus:ring-2 focus:ring-accent/20 ${
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            className={`w-full rounded-xl border bg-white/70 px-3.5 py-2.5 pr-16 text-sm outline-none transition-colors placeholder:text-muted-foreground/60 focus:border-accent focus:ring-2 focus:ring-accent/20 ${
